...
const Contato = () => {
    const handleSubmit = (e) => {
        ...
        const texto = `Olá, me chamo${nome}! %OATelefone: ${telefone} %OAEmail: ${email} %OAMensagem: ${mensagem}`;

        window.open(`https://wa.me/5521997916447?text=${texto}`, "_blank");
        ...
        <section className="contato" id="contato">
            ...
            <div className="container">
                ...
                <div className="dados">
                    ...
                    <p><strong>Whatsapp: </strong>(21)99791-6447</p>
                ...
                <div className="social">
                    ...
                    <a href="https://wa.me/5521997916447" target="_blanck" rel="noopener noreferrer"><i className="fab fa-whatsapp"></i></a>
                </div>
            </div>
